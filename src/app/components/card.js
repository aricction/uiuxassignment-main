...
const Card = ({ id, title, img, status, assignee, icons, box, comment, time, attach, color }) => {
  ...
  return (
    <div className="flex flex-2 ml-4 m-2 text-black lg:w-[260px] sm:w-[100%] h-[100px] p-2 pl-2 rounded-lg shadow-md mb-15 bg-white">
      <div className="mb-5 items-center">
        {/* Status Bar */}
        <div className="stat-bar mt-0 gap-2 w-[200px] h-[8px] rounded-lg flex">
          {color?.map((col, index) => (
        ...
        <div className="relative flex items-center justify-between">
          ...
          <div className="mt-3 absolute lg:ml-[200px] ml-[360px] sm:ml-[300px] avatar h-[25px] w-[25px] rounded-full flex justify-center items-center text-black font-bold text-sm">          
            {assignee.length > 0 &&
